...
module.exports = function (grunt) {
  ...
  var requireJSPaths = {
    ...
    "moment": "lib/moment/min/moment-with-langs.min",
  ...
  grunt.initConfig({
    ...
    clean: {
      ...
      afterBuild: {
        ...
        src: [
          ...
          '../mt-static/plugins/Loupe/components',
    ...
    bulkSymlink: {
      ...
      dev: {
        targets: grunt.util._.map(grunt.file.expand({
          filter: 'isDirectory',
          cwd: 'app/'
      ...
      build: {
        options: {
          ...
          data: {
            ...
            cards: ['showYourUserAgent'], // temporary string for dev,
            manifestFile: null
          }
        },
        files: {
