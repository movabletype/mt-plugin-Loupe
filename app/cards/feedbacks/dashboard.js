define(['backbone.marionette', 'js/device', 'cards/feedbacks/models/comments_collection', 'cards/feedbacks/models/trackbacks_collection', 'hbs!cards/feedbacks/templates/dashboard', 'mtchart'],
