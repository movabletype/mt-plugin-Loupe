define(['backbone.marionette', 'js/commands', 'hbs!js/views/dashboard/templates/layout', 'js/views/dashboard/header', 'js/views/dashboard/main'], function (Marionette, commands, template, HeaderView, MainLayout) {
  "use strict";
